...
class TPR(Resource):
	...
	def getShort(self, data, index):
		...
		logger.info("data: %s, index: %s", data,index)
	...
	def getChar(self, data,index):
		...
		result = data[index]
		logger.info("data: %s, index: %s, result: %s", data,index, result)
		if result > 127:
			result -= 256
		return result
	...
	def readBME280ID(self, addr=DEVICE):
		...
		logger.info("addr: %s, chip_id: %s, chip_version: %s", addr, chip_id, chip_version)
	...
	def readBME280All(self, addr=DEVICE):
		...
		logger.info("cal1: %s, cal2: %s, cal3: %s", cal1, cal2, cal3)
		
		# Convert byte data to word values
		dig_T1 = self.getUShort(cal1, 0)
		dig_T2 = self.getShort(cal1, 2)
		dig_T3 = self.getShort(cal1, 4)
		logger.info("dig_T1: %s, dig_T2: %s, dig_T3: %s", dig_T1, dig_T2, dig_T3)
